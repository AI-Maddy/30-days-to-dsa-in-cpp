/*
 * Exercise 7: Bellman Ford Relax (Graph Traversals (BFS DFS) plus Flood Fill plus Rotten Oranges plus Number of Islands)
 */
#include <iostream>
#include <vector>
#include <queue>
...
// 4) Return final computed result.
    int bellman_ford_relax(int n, vector<vector<int>>& adj) {
        int edges = 0;
