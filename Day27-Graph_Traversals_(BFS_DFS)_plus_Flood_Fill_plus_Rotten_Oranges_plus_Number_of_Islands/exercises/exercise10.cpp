/*
 * Exercise 10: Number Of Islands (Graph Traversals (BFS DFS) plus Flood Fill plus Rotten Oranges plus Number of Islands)
 */
#include <iostream>
#include <vector>
#include <queue>
...
// 4) Return final computed result.
    int number_of_islands(int n, vector<vector<int>>& adj) {
        int edges = 0;
