/*
 * Solution 4: Cycle Detection Directed (Graph Traversals (BFS DFS) plus Flood Fill plus Rotten Oranges plus Number of Islands)
 */
#include <iostream>
#include <vector>
#include <queue>
...
int main() {
    ...
    Solution s; cout << s.cycle_detection_directed(n, g) << "\n"; return 0;
}
