/*
 * Solution 10: Number Of Islands (Graph Traversals (BFS DFS) plus Flood Fill plus Rotten Oranges plus Number of Islands)
 */
#include <iostream>
#include <vector>
#include <queue>
...
int main() {
    ...
    Solution s; cout << s.number_of_islands(n, g) << "\n"; return 0;
}
