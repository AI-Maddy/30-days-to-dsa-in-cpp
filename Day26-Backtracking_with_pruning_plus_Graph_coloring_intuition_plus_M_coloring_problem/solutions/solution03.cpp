/*
 * Solution 3: Combination Sum (Backtracking with pruning plus Graph coloring intuition plus M coloring problem)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return final query/optimization result.
    int combination_sum(vector<int>& nums) {
        int ans = 0;
...
int main() {
    ...
    Solution s; cout << s.combination_sum(nums) << "\n"; return 0;
}
