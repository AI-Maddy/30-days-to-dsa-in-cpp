/*
 * Solution 8: Palindrome Partition (Backtracking with pruning plus Graph coloring intuition plus M coloring problem)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int main() {
    ...
    Solution s; cout << s.palindrome_partition(nums) << "\n"; return 0;
}
