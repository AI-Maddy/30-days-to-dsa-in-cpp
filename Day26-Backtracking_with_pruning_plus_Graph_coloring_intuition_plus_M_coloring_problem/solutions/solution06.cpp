/*
 * Solution 6: Sudoku Validate Step (Backtracking with pruning plus Graph coloring intuition plus M coloring problem)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return final computed result.
    int sudoku_validate_step(vector<int>& nums) {
        int ans = 0;
...
int main() {
    ...
    Solution s; cout << s.sudoku_validate_step(nums) << "\n"; return 0;
}
