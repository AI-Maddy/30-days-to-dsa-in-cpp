/*
 * Example 8: Palindrome Partition (Backtracking with pruning plus Graph coloring intuition plus M coloring problem)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int palindrome_partition(vector<int> a) {
...
int main() {
    ...
    cout << palindrome_partition(data) << "\n";
    return 0;
}
