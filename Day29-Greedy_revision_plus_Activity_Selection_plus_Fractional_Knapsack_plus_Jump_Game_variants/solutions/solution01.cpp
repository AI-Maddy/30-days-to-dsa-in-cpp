/*
 * Solution 1: Activity Selection (Greedy revision plus Activity Selection plus Fractional Knapsack plus Jump Game variants)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return final computed result.
    int activity_selection(vector<int>& nums) {
        int ans = 0;
...
int main() {
    ...
    Solution s; cout << s.activity_selection(nums) << "\n"; return 0;
}
