/*
 * Solution 10: Task Scheduling Greedy (Greedy revision plus Activity Selection plus Fractional Knapsack plus Jump Game variants)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int main() {
    ...
    Solution s; cout << s.task_scheduling_greedy(nums) << "\n"; return 0;
}
