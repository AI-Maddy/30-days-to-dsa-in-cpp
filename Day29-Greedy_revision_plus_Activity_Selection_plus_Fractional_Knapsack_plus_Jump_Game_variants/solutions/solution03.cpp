/*
 * Solution 3: Jump Game Reachability (Greedy revision plus Activity Selection plus Fractional Knapsack plus Jump Game variants)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return final computed result.
    int jump_game_reachability(vector<int>& nums) {
        int ans = 0;
...
int main() {
    ...
    Solution s; cout << s.jump_game_reachability(nums) << "\n"; return 0;
}
