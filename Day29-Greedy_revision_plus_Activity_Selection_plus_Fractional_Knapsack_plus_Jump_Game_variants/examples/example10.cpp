/*
 * Example 10: Task Scheduling Greedy (Greedy revision plus Activity Selection plus Fractional Knapsack plus Jump Game variants)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int task_scheduling_greedy(vector<int> a) {
    int ans = 0;
...
int main() {
    ...
    cout << task_scheduling_greedy(data) << "\n";
    return 0;
}
