/*
 * Example 9: Dutch Flag Partition (Binary Search on 1D and 2D plus Binary Search on Answer pattern)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int dutch_flag_partition(vector<int> a) {
...
int main() {
    ...
    cout << dutch_flag_partition(data) << "\n";
    return 0;
}
