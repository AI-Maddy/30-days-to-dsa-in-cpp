/*
 * Example 2: Climbing Stairs (1D DP patterns plus Mini revision plus Solve mixed medium hard problems)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int climbing_stairs(vector<int> a) {
