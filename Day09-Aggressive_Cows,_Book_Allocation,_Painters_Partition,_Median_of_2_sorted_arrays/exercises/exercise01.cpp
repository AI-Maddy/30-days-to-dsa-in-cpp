/*
 * Exercise 1: Classic Binary Search (Aggressive Cows, Book Allocation, Painters Partition, Median of 2 sorted arrays)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return found index/value or fallback result.
    int classic_binary_search(vector<int>& nums) {
        int ans = 0;
