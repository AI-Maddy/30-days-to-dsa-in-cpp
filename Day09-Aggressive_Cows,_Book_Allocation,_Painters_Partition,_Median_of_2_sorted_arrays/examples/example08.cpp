/*
 * Example 8: Binary Search Answer (Aggressive Cows, Book Allocation, Painters Partition, Median of 2 sorted arrays)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int binary_search_answer(vector<int> a) {
...
int main() {
    ...
    cout << binary_search_answer(data) << "\n";
    return 0;
}
