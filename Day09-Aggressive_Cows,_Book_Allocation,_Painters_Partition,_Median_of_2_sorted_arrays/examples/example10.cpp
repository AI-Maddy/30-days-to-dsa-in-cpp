/*
 * Example 10: Maximum Feasible (Aggressive Cows, Book Allocation, Painters Partition, Median of 2 sorted arrays)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int maximum_feasible(vector<int> a) {
    int ans = 0;
