/*
 * Example 6: Rotated Search (Aggressive Cows, Book Allocation, Painters Partition, Median of 2 sorted arrays)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int rotated_search(vector<int> a) {
