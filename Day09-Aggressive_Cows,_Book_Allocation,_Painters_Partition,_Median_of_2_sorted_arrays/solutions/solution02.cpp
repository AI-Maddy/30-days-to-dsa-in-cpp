/*
 * Solution 2: Lower Bound (Aggressive Cows, Book Allocation, Painters Partition, Median of 2 sorted arrays)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
class Solution {
public:
// --- Function Explanation: lower_bound ---
// Purpose    : Locate target condition/index via `lower_bound`.
...
int main() {
    Solution s; vector<int> a = {2, 4, 6, 8};
    cout << s.lower_bound(a, 6) << "\n";
    return 0;
}
