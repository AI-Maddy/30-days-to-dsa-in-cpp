/*
 * Solution 8: Binary Search Answer (Aggressive Cows, Book Allocation, Painters Partition, Median of 2 sorted arrays)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
class Solution {
public:
// --- Function Explanation: binary_search_answer ---
// Purpose    : Locate target condition/index via `binary_search_answer`.
...
// 4) Return found index/value or fallback result.
    int binary_search_answer(vector<int>& a, int target) {
...
int main() {
    Solution s; vector<int> a = {8, 10, 12, 14};
    cout << s.binary_search_answer(a, 12) << "\n";
    return 0;
}
