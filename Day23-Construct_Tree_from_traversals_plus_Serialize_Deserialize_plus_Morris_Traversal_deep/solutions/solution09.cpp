/*
 * Solution 9: Boundary Traversal (Construct Tree from traversals plus Serialize Deserialize plus Morris Traversal deep)
 */
#include <iostream>
#include <queue>
using namespace std;
...
int main() {
    ...
    Solution s; cout << s.boundary_traversal(r) + 9 << "\n"; return 0;
}
