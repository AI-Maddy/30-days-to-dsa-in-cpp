...
export default function Day22BinarySearchTreeValidateFloorCeilKthSmallestLcaExercises2Page() {
  const code = "/*\n * Exercise 2: Floor and Ceil\n */\n#include <bits/stdc++.h>\nusing namespace std;\nstruct TreeNode { int val; TreeNode *left,*right; TreeNode(int v):val(v),left(nullptr),right(nullptr){} };\n// Exercise 2: Floor and Ceil in BST\n// Hint: Traverse BST; if node < key \u2192 floor candidate, go right; if node > key \u2192 ceil candidate, go left.\npair<int,int> floorCeil(TreeNode* root, int key) { return {-1,-1}; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 22 — Exercise 2</div>
