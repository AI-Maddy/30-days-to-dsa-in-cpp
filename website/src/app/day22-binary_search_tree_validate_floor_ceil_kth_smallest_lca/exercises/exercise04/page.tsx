...
export default function Day22BinarySearchTreeValidateFloorCeilKthSmallestLcaExercises4Page() {
  const code = "/*\n * Exercise 4: LCA in BST\n */\n#include <bits/stdc++.h>\nusing namespace std;\nstruct TreeNode { int val; TreeNode *left,*right; TreeNode(int v):val(v),left(nullptr),right(nullptr){} };\n// Exercise 4: LCA in BST\n// Hint: If both p,q < root \u2192 go left; if both > root \u2192 go right; else root is LCA.\nTreeNode* lcaBST(TreeNode* root, int p, int q) { return nullptr; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 22 — Exercise 4</div>
