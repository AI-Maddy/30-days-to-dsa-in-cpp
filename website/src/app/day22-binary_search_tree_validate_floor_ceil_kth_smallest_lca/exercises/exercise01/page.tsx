...
export default function Day22BinarySearchTreeValidateFloorCeilKthSmallestLcaExercises1Page() {
  const code = "/*\n * Exercise 1: Validate BST\n */\n#include <bits/stdc++.h>\nusing namespace std;\nstruct TreeNode { int val; TreeNode *left,*right; TreeNode(int v):val(v),left(nullptr),right(nullptr){} };\n// Exercise 1: Validate BST\n// Hint: Pass min/max bounds through recursion; use LONG_MIN/LONG_MAX to handle INT extremes.\nbool isValidBST(TreeNode* root) { return false; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 22 — Exercise 1</div>
