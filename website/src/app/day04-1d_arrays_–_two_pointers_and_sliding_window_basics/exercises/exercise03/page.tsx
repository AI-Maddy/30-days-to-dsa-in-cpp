...
export default function Day041dArraysTwoPointersAndSlidingWindowBasicsExercises3Page() {
  const code = "/*\n * Exercise 3: Trapping Rain Water (1D Arrays \u2013 Two Pointers and Sliding Window basics)\n */\n// Problem: Given heights, compute total trapped water.\n// Hint: Two pointer with running left/right max\n#include <bits/stdc++.h>\nusing namespace std;\n\nvoid solve() {\n    // TODO: Two pointer with running left/right max\n}\n\nint main() {\n    solve();\n    return 0;\n}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 04 — Exercise 3</div>
