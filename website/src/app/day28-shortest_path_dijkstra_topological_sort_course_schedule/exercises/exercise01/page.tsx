...
export default function Day28ShortestPathDijkstraTopologicalSortCourseScheduleExercises1Page() {
  const code = "/*\n * Exercise 1: Dijkstra SSSP\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 1: Dijkstra's Algorithm\n// Hint: Use min-heap (priority_queue with greater<>); only relax if new distance is better.\nvector<int> dijkstra(int src, int n, vector<vector<pair<int,int>>>& adj) { return {}; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 28 — Exercise 1</div>
