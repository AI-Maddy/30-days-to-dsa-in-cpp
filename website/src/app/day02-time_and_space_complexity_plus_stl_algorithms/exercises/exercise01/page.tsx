...
export default function Day02TimeAndSpaceComplexityPlusStlAlgorithmsExercises1Page() {
  const code = "/*\n * Exercise 1: Vector Sort (Time and Space Complexity plus STL Algorithms)\n */\n// Practice: sort variants\n// Hint: Use sort, stable_sort with lambdas\n#include <bits/stdc++.h>\nusing namespace std;\n\nvoid solve() {\n    // TODO: implement using Use sort, stable_sort with lambdas\n}\n\nint main() {\n    solve();\n    return 0;\n}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 02 — Exercise 1</div>
