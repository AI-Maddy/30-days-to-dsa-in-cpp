...
export default function Day03BitManipulationInCplusplusExercises4Page() {
  const code = "/*\n * Exercise 4: Toggle Bit (Bit Manipulation in Cplusplus)\n */\n// Problem: Reverse 32 bits\n// Hint: Shift result left and append each bit of n from right\n#include <bits/stdc++.h>\nusing namespace std;\n\nvoid solve() {\n    uint32_t n; cin>>n;\n    // TODO: Shift result left and append each bit of n from right\n}\n\nint main() {\n    solve();\n    return 0;\n}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 03 — Exercise 4</div>
