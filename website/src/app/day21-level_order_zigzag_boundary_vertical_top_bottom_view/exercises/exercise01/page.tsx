...
export default function Day21LevelOrderZigzagBoundaryVerticalTopBottomViewExercises1Page() {
  const code = "/*\n * Exercise 1: Level Order BFS\n */\n#include <bits/stdc++.h>\nusing namespace std;\nstruct TreeNode { int val; TreeNode *left,*right; TreeNode(int v):val(v),left(nullptr),right(nullptr){} };\n\n// Exercise 1: Level-Order Traversal\n// Return all node values level by level.\n// Hint: Use a queue; for each level drain all nodes and collect children.\nvector<vector<int>> levelOrder(TreeNode* root) {\n    // TODO\n    return {};\n}\nint main() { /* build tree and test */ }\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 21 — Exercise 1</div>
