...
export default function Day21LevelOrderZigzagBoundaryVerticalTopBottomViewExercises4Page() {
  const code = "/*\n * Exercise 4: Bottom View\n */\n#include <bits/stdc++.h>\nusing namespace std;\nstruct TreeNode { int val; TreeNode *left,*right; TreeNode(int v):val(v),left(nullptr),right(nullptr){} };\n\n// Exercise 4: Bottom View\n// Print the last visible node for each horizontal distance.\n// Hint: Same BFS but overwrite map[col] each time.\nvoid bottomView(TreeNode* root) {\n    // TODO\n}\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 21 — Exercise 4</div>
