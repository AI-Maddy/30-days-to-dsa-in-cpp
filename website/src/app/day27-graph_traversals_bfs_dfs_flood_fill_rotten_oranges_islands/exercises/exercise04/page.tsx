...
export default function Day27GraphTraversalsBfsDfsFloodFillRottenOrangesIslandsExercises4Page() {
  const code = "/*\n * Exercise 4: Rotten Oranges\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 4: Rotten Oranges\n// Hint: Multi-source BFS starting from all rotten oranges simultaneously; count minutes.\nint orangesRotting(vector<vector<int>>& grid) { return -1; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 27 — Exercise 4</div>
