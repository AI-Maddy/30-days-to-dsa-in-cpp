...
export default function Day27GraphTraversalsBfsDfsFloodFillRottenOrangesIslandsExercises1Page() {
  const code = "/*\n * Exercise 1: BFS and DFS\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 1: BFS and DFS traversal\n// Hint: BFS uses queue + visited; DFS can be recursive or use explicit stack.\nvoid bfs(int src, vector<vector<int>>& adj, int n) { /* TODO */ }\nvoid dfs(int u, vector<vector<int>>& adj, vector<bool>& vis) { /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 27 — Exercise 1</div>
