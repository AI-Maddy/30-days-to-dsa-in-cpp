...
export default function Day27GraphTraversalsBfsDfsFloodFillRottenOrangesIslandsExercises3Page() {
  const code = "/*\n * Exercise 3: Flood Fill\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 3: Flood Fill\n// Hint: BFS from (sr,sc); replace original color; enqueue 4-directional same-original-color cells.\nvector<vector<int>> floodFill(vector<vector<int>>& image, int sr, int sc, int color) { return {}; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 27 — Exercise 3</div>
