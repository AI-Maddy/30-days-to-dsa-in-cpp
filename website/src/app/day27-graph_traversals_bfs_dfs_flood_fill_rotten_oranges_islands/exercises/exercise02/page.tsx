...
export default function Day27GraphTraversalsBfsDfsFloodFillRottenOrangesIslandsExercises2Page() {
  const code = "/*\n * Exercise 2: Number of Islands\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 2: Number of Islands\n// Hint: For each unvisited '1', BFS/DFS to mark entire island as visited, increment count.\nint numIslands(vector<vector<char>>& grid) { return 0; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 27 — Exercise 2</div>
