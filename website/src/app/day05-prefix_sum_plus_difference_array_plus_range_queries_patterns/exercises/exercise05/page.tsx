...
export default function Day05PrefixSumPlusDifferenceArrayPlusRangeQueriesPatternsExercises5Page() {
  const code = "/*\n * Exercise 5: Rotate Array (Prefix Sum plus Difference Array plus Range queries patterns)\n */\n// Problem: Rotate array right by k positions\n// Hint: Three reverses: [0,n-k-1], [n-k,n-1], [0,n-1]\n#include <bits/stdc++.h>\nusing namespace std;\nvoid solve() {\n    // TODO: Three reverses: [0,n-k-1], [n-k,n-1], [0,n-1]\n}\nint main() { solve(); return 0; }\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 05 — Exercise 5</div>
