...
export default function Day05PrefixSumPlusDifferenceArrayPlusRangeQueriesPatternsExercises4Page() {
  const code = "/*\n * Exercise 4: Difference Array Update (Prefix Sum plus Difference Array plus Range queries patterns)\n */\n// Problem: Apply m range-add ops, print final array\n// Hint: diff[l]+=v; diff[r+1]-=v; then prefix sum\n#include <bits/stdc++.h>\nusing namespace std;\nvoid solve() {\n    // TODO: diff[l]+=v; diff[r+1]-=v; then prefix sum\n}\nint main() { solve(); return 0; }\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 05 — Exercise 4</div>
