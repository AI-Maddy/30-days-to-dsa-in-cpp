...
export default function Day05PrefixSumPlusDifferenceArrayPlusRangeQueriesPatternsExercises1Page() {
  const code = "/*\n * Exercise 1: Prefix Sum Query (Prefix Sum plus Difference Array plus Range queries patterns)\n */\n// Problem: Answer Q range sum queries on array\n// Hint: pre[r+1]-pre[l]\n#include <bits/stdc++.h>\nusing namespace std;\nvoid solve() {\n    // TODO: pre[r+1]-pre[l]\n}\nint main() { solve(); return 0; }\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 05 — Exercise 1</div>
