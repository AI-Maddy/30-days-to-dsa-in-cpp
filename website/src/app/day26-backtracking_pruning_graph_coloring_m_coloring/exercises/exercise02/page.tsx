...
export default function Day26BacktrackingPruningGraphColoringMColoringExercises2Page() {
  const code = "/*\n * Exercise 2: Palindrome Partition\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 2: Palindrome Partitioning\n// Hint: For each prefix that is a palindrome, recurse on the remaining suffix.\nvoid partition(const string& s, int start, vector<string>& cur, vector<vector<string>>& res) {\n    // TODO\n}\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 26 — Exercise 2</div>
