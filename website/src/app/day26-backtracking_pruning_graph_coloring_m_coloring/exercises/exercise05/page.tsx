...
export default function Day26BacktrackingPruningGraphColoringMColoringExercises5Page() {
  const code = "/*\n * Exercise 5: Restore IP Addresses\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 5: Restore IP Addresses\n// Hint: Split into 4 parts; each part 1-3 digits, value 0-255, no leading zeros.\nvoid restoreIPs(const string& s, int idx, int parts, string cur, vector<string>& res) {\n    // TODO\n}\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 26 — Exercise 5</div>
