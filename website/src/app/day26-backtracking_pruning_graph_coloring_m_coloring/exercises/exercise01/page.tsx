...
export default function Day26BacktrackingPruningGraphColoringMColoringExercises1Page() {
  const code = "/*\n * Exercise 1: M-Coloring\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 1: M-Coloring Problem\n// Hint: Try colors 1..m for each node; if no neighbor has same color, assign and recurse.\nbool mColoring(int node, int n, int m, vector<vector<int>>& adj, vector<int>& color) {\n    return false; // TODO\n}\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 26 — Exercise 1</div>
