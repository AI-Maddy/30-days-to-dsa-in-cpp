...
export default function Day25NQueensSudokuSolverWordSearchRatInMazeExercises3Page() {
  const code = "/*\n * Exercise 3: Sudoku Solver\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 3: Sudoku Solver\n// Hint: Find next empty cell; try '1'-'9'; validate row, col, and 3x3 box; backtrack on failure.\nbool solveSudoku(vector<vector<char>>& board) { return false; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 25 — Exercise 3</div>
