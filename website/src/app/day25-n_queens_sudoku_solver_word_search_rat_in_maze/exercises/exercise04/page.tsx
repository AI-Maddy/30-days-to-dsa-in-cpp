...
export default function Day25NQueensSudokuSolverWordSearchRatInMazeExercises4Page() {
  const code = "/*\n * Exercise 4: Word Search\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 4: Word Search in 2D grid\n// Hint: DFS from each cell; mark visited with temporary char '#'; restore after DFS.\nbool wordSearch(vector<vector<char>>& board, const string& word) { return false; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 25 — Exercise 4</div>
