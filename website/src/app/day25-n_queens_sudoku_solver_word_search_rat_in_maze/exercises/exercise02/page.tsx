...
export default function Day25NQueensSudokuSolverWordSearchRatInMazeExercises2Page() {
  const code = "/*\n * Exercise 2: N-Queens Bitmask\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 2: N-Queens count only (bitmask optimization)\n// Hint: Track 3 bitmasks: cols, diag1 (top-left), diag2 (top-right). Shift diags each row.\nint totalNQueens(int n) { return 0; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 25 — Exercise 2</div>
