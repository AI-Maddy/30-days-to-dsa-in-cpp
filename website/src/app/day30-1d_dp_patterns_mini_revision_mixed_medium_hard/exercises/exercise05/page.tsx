...
export default function Day301dDpPatternsMiniRevisionMixedMediumHardExercises5Page() {
  const code = "/*\n * Exercise 5: Edit Distance LCS\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 5: Edit Distance\n// Hint: dp[i][j] = 0 if chars match else 1 + min(insert, delete, replace) from dp[i-1][j], dp[i][j-1], dp[i-1][j-1].\nint minDistance(const string& word1, const string& word2) { return 0; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 30 — Exercise 5</div>
