...
export default function Day301dDpPatternsMiniRevisionMixedMediumHardExercises4Page() {
  const code = "/*\n * Exercise 4: 0-1 Knapsack\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 4: 0/1 Knapsack (space-optimized)\n// Hint: Single dp[W+1] array; iterate weights BACKWARDS to avoid using same item twice.\nint knapsack(vector<int>& wt, vector<int>& val, int W) { return 0; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 30 — Exercise 4</div>
