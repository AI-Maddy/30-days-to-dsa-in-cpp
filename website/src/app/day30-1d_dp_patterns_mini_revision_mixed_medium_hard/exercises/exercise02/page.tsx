...
export default function Day301dDpPatternsMiniRevisionMixedMediumHardExercises2Page() {
  const code = "/*\n * Exercise 2: Coin Change\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 2: Coin Change (minimum coins)\n// Hint: dp[0]=0; for each amount, try all coins; dp[i]=min(dp[i], dp[i-coin]+1).\nint coinChange(vector<int>& coins, int amount) { return -1; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 30 — Exercise 2</div>
