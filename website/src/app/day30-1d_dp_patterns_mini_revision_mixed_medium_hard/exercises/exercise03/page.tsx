...
export default function Day301dDpPatternsMiniRevisionMixedMediumHardExercises3Page() {
  const code = "/*\n * Exercise 3: LIS O(nlogn)\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Exercise 3: LIS \u2014 Longest Increasing Subsequence\n// Hint for O(n log n): maintain 'tails' array; binary search for placement position.\nint lengthOfLIS(vector<int>& nums) { return 0; /* TODO */ }\nint main() {}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 30 — Exercise 3</div>
