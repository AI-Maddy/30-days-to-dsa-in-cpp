...
export default function Day09AggressiveCowsBookAllocationPaintersPartitionMedianOf2SortedArraysExercises4Page() {
  const code = "/*\n * Exercise 4: First Occurrence (BS Answer)\n */\n#include <bits/stdc++.h>\nusing namespace std;\n// Median of two sorted arrays in O(log(min(m,n)))\nvoid solve(){}\nint main(){solve();return 0;}\n";
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8 pb-16">
        ...
        <div className="flex items-center gap-3 mt-3 mb-8">
          ...
          <div>
            <div className="text-xs text-slate-500 uppercase tracking-widest">Day 09 — Exercise 4</div>
