/*
 * Example 2: Selection Sort Pass (Sorting revision plus Custom comparators plus Counting Sort Radix Sort intuition)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int selection_sort_pass(vector<int> a) {
