/*
 * Example 10: Interval Sort (Sorting revision plus Custom comparators plus Counting Sort Radix Sort intuition)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int interval_sort(vector<int> a) {
    int ans = 0;
