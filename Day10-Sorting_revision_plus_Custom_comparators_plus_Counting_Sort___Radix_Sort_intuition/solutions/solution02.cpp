/*
 * Solution 2: Selection Sort Pass (Sorting revision plus Custom comparators plus Counting Sort Radix Sort intuition)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
int main() {
    ...
    Solution s; cout << s.selection_sort_pass(nums) << "\n"; return 0;
}
