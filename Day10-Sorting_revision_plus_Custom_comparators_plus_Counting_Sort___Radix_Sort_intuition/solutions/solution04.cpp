/*
 * Solution 4: Sort Pairs (Sorting revision plus Custom comparators plus Counting Sort Radix Sort intuition)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return sorted/rearranged sequence or computed metric.
    int sort_pairs(vector<int>& nums) {
        int ans = 0;
...
int main() {
    ...
    Solution s; cout << s.sort_pairs(nums) << "\n"; return 0;
}
