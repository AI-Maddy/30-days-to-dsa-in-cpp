/*
 * Solution 7: Count Inversions Idea (Sorting revision plus Custom comparators plus Counting Sort Radix Sort intuition)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return final computed result.
    int count_inversions_idea(vector<int>& nums) {
        int ans = 0;
...
int main() {
    ...
    Solution s; cout << s.count_inversions_idea(nums) << "\n"; return 0;
}
