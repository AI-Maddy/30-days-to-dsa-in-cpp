/*
 * Solution 1: Insertion Sort Pass (Sorting revision plus Custom comparators plus Counting Sort Radix Sort intuition)
 */
#include <iostream>
#include <vector>
#include <algorithm>
...
// 4) Return sorted/rearranged sequence or computed metric.
    int insertion_sort_pass(vector<int>& nums) {
        int ans = 0;
...
int main() {
    ...
    Solution s; cout << s.insertion_sort_pass(nums) << "\n"; return 0;
}
