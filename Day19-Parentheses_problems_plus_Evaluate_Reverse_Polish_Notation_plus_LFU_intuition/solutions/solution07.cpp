/*
 * Solution 7: Queue With Two Stacks (Parentheses problems plus Evaluate Reverse Polish Notation plus LFU intuition)
 */
#include <iostream>
#include <vector>
#include <stack>
...
int main() {
    ...
    Solution s; cout << s.queue_with_two_stacks(nums) << "\n"; return 0;
}
