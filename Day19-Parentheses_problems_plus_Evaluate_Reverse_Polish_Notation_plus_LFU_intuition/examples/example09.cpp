/*
 * Example 9: Histogram Area (Parentheses problems plus Evaluate Reverse Polish Notation plus LFU intuition)
 */
#include <iostream>
#include <vector>
#include <stack>
...
int histogram_area(vector<int> a) {
